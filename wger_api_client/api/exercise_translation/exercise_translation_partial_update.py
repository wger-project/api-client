...
from ...models.patched_exercise_translation_request import (
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedExerciseTranslationRequest | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedExerciseTranslationRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedExerciseTranslationRequest | Unset): Exercise translation serializer
        body (PatchedExerciseTranslationRequest | Unset): Exercise translation serializer
        body (PatchedExerciseTranslationRequest | Unset): Exercise translation serializer

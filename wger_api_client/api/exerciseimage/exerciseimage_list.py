...
from ...models.paginated_exercise_image_list import PaginatedExerciseImageList
...
) -> PaginatedExerciseImageList | None:
    if response.status_code == 200:
        response_200 = PaginatedExerciseImageList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedExerciseImageList]:
    return Response(

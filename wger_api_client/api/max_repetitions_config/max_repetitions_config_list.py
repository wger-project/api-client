...
def _get_kwargs(
    *,
    ...
    operation: MaxRepetitionsConfigListOperation | Unset = UNSET,
    ordering: str | Unset = UNSET,
    repeat: bool | Unset = UNSET,
    slot_entry: int | Unset = UNSET,
    step: MaxRepetitionsConfigListStep | Unset = UNSET,
...
) -> PaginatedMaxRepetitionsConfigList | None:
    if response.status_code == 200:
        response_200 = PaginatedMaxRepetitionsConfigList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedMaxRepetitionsConfigList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        limit (int | Unset):
        offset (int | Unset):
        operation (MaxRepetitionsConfigListOperation | Unset):
        ordering (str | Unset):
        repeat (bool | Unset):
        slot_entry (int | Unset):
        step (MaxRepetitionsConfigListStep | Unset):
        value (float | Unset):

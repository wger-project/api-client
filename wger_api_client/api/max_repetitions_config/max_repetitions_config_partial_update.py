...
from ...models.patched_max_repetitions_config_request import (
...
def _get_kwargs(
    id: int,
    *,
    body: PatchedMaxRepetitionsConfigRequest | Unset = UNSET,
) -> dict[str, Any]:
    ...
    if isinstance(body, PatchedMaxRepetitionsConfigRequest):
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (int):
        body (PatchedMaxRepetitionsConfigRequest | Unset): Max Repetition Config serializer
        body (PatchedMaxRepetitionsConfigRequest | Unset): Max Repetition Config serializer
        body (PatchedMaxRepetitionsConfigRequest | Unset): Max Repetition Config serializer

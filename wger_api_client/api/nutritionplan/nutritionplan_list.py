...
from ...models.paginated_nutrition_plan_list import PaginatedNutritionPlanList
...
) -> PaginatedNutritionPlanList | None:
    if response.status_code == 200:
        response_200 = PaginatedNutritionPlanList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedNutritionPlanList]:
    return Response(

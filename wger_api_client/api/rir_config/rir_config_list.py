...
def _get_kwargs(
    *,
    ...
    operation: RirConfigListOperation | Unset = UNSET,
    ordering: str | Unset = UNSET,
    repeat: bool | Unset = UNSET,
    slot_entry: int | Unset = UNSET,
    step: RirConfigListStep | Unset = UNSET,
...
) -> PaginatedRiRConfigList | None:
    if response.status_code == 200:
        response_200 = PaginatedRiRConfigList.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PaginatedRiRConfigList]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        limit (int | Unset):
        offset (int | Unset):
        operation (RirConfigListOperation | Unset):
        ordering (str | Unset):
        repeat (bool | Unset):
        slot_entry (int | Unset):
        step (RirConfigListStep | Unset):
        value (float | Unset):

...
from ...models.workout_day_data_display_mode import WorkoutDayDataDisplayMode
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/routine/{id}/date-sequence-display/".format(
...
) -> list[WorkoutDayDataDisplayMode] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = WorkoutDayDataDisplayMode.from_dict(
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[list[WorkoutDayDataDisplayMode]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        list[WorkoutDayDataDisplayMode]
    """

...
from ...models.workout_day_data_gym_mode import WorkoutDayDataGymMode
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v2/routine/{id}/date-sequence-gym/".format(
...
) -> list[WorkoutDayDataGymMode] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = WorkoutDayDataGymMode.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[list[WorkoutDayDataGymMode]]:
    return Response(

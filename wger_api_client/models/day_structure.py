...
if TYPE_CHECKING:
    from ..models.slot_structure import SlotStructure


T = TypeVar("T", bound="DayStructure")
...
class DayStructure:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for slots_item_data in _slots:
            slots_item = SlotStructure.from_dict(slots_item_data)
        ...
        day_structure.additional_properties = d

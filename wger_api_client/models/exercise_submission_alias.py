...
T = TypeVar("T", bound="ExerciseSubmissionAlias")


@_attrs_define
class ExerciseSubmissionAlias:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        exercise_submission_alias = cls(
            id=id,
            uuid=uuid,
            alias=alias,
        )

        exercise_submission_alias.additional_properties = d
        return exercise_submission_alias

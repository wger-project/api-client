...
T = TypeVar("T", bound="ExerciseSubmissionComment")


@_attrs_define
class ExerciseSubmissionComment:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        exercise_submission_comment = cls(
            id=id,
            uuid=uuid,
            comment=comment,
        )

        exercise_submission_comment.additional_properties = d
        return exercise_submission_comment

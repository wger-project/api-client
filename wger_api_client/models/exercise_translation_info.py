...
if TYPE_CHECKING:
    ...
    from ..models.exercise_info_alias import ExerciseInfoAlias


T = TypeVar("T", bound="ExerciseTranslationInfo")


@_attrs_define
class ExerciseTranslationInfo:
    ...
    Attributes:
        ...
        language (int):
        aliases (list[ExerciseInfoAlias]):
        notes (list[ExerciseComment]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for aliases_item_data in _aliases:
            aliases_item = ExerciseInfoAlias.from_dict(aliases_item_data)
        ...
        for notes_item_data in _notes:
            notes_item = ExerciseComment.from_dict(notes_item_data)
        ...
        exercise_translation_info.additional_properties = d
        return exercise_translation_info

...
T = TypeVar("T", bound="ExerciseVideoInfo")


@_attrs_define
class ExerciseVideoInfo:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        exercise_video_info.additional_properties = d
        return exercise_video_info

...
T = TypeVar("T", bound="ExerciseVideoRequest")


@_attrs_define
class ExerciseVideoRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        exercise_video_request.additional_properties = d
        return exercise_video_request

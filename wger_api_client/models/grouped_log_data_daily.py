...
T = TypeVar("T", bound="GroupedLogDataDaily")
...
class GroupedLogDataDaily:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        grouped_log_data_daily.additional_properties = additional_properties
        return grouped_log_data_daily

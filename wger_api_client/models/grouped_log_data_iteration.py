...
T = TypeVar("T", bound="GroupedLogDataIteration")


@_attrs_define
class GroupedLogDataIteration:
    """ """
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        d = dict(src_dict)
        grouped_log_data_iteration = cls()
        ...
        grouped_log_data_iteration.additional_properties = additional_properties
        return grouped_log_data_iteration

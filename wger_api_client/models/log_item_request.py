...
T = TypeVar("T", bound="LogItemRequest")


@_attrs_define
class LogItemRequest:
    """LogItem serializer
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.meal, Unset):
            if isinstance(self.meal, UUID):
                files.append(("meal", (None, str(self.meal), "text/plain")))
            else:
                files.append(("meal", (None, str(self.meal).encode(), "text/plain")))
        ...
        if not isinstance(self.datetime_, Unset):
            files.append(
                ("datetime", (None, self.datetime_.isoformat().encode(), "text/plain"))
            )
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        log_item_request.additional_properties = d
        return log_item_request

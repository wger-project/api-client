...
T = TypeVar("T", bound="MaxRepetitionsConfig")


@_attrs_define
class MaxRepetitionsConfig:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        max_repetitions_config.additional_properties = d
        return max_repetitions_config

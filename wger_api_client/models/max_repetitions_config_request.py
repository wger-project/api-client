...
T = TypeVar("T", bound="MaxRepetitionsConfigRequest")


@_attrs_define
class MaxRepetitionsConfigRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        files.append(("iteration", (None, str(self.iteration).encode(), "text/plain")))
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        max_repetitions_config_request = cls(
            slot_entry=slot_entry,
            iteration=iteration,
            value=value,
            operation=operation,
        ...
        max_repetitions_config_request.additional_properties = d
        return max_repetitions_config_request

...
T = TypeVar("T", bound="MaxRestConfigRequest")


@_attrs_define
class MaxRestConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        max_rest_config_request.additional_properties = d
        return max_rest_config_request

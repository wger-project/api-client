...
T = TypeVar("T", bound="MaxSetNrConfigRequest")


@_attrs_define
class MaxSetNrConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        max_set_nr_config_request.additional_properties = d
        return max_set_nr_config_request

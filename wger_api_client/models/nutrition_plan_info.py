...
if TYPE_CHECKING:
    from ..models.meal_info import MealInfo


T = TypeVar("T", bound="NutritionPlanInfo")


@_attrs_define
class NutritionPlanInfo:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for meals_item_data in _meals:
            meals_item = MealInfo.from_dict(meals_item_data)
        ...
        nutrition_plan_info.additional_properties = d
        return nutrition_plan_info

...
T = TypeVar("T", bound="PaginatedDayList")


@_attrs_define
class PaginatedDayList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Day.from_dict(results_item_data)
        ...
        paginated_day_list.additional_properties = d
        return paginated_day_list

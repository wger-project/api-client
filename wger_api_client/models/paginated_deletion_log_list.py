...
T = TypeVar("T", bound="PaginatedDeletionLogList")


@_attrs_define
class PaginatedDeletionLogList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[DeletionLog]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = DeletionLog.from_dict(results_item_data)
        ...
        paginated_deletion_log_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_deletion_log_list.additional_properties = d
        return paginated_deletion_log_list

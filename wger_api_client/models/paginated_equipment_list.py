...
T = TypeVar("T", bound="PaginatedEquipmentList")


@_attrs_define
class PaginatedEquipmentList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Equipment.from_dict(results_item_data)
        ...
        paginated_equipment_list.additional_properties = d
        return paginated_equipment_list

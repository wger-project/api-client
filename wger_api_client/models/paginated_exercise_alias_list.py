...
T = TypeVar("T", bound="PaginatedExerciseAliasList")


@_attrs_define
class PaginatedExerciseAliasList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ExerciseAlias]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ExerciseAlias.from_dict(results_item_data)
        ...
        paginated_exercise_alias_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_exercise_alias_list.additional_properties = d
        return paginated_exercise_alias_list

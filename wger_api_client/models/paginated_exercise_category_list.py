...
T = TypeVar("T", bound="PaginatedExerciseCategoryList")


@_attrs_define
class PaginatedExerciseCategoryList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ExerciseCategory]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ExerciseCategory.from_dict(results_item_data)
        ...
        paginated_exercise_category_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_exercise_category_list.additional_properties = d
        return paginated_exercise_category_list

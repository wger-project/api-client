...
T = TypeVar("T", bound="PaginatedExerciseCommentList")


@_attrs_define
class PaginatedExerciseCommentList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ExerciseComment]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ExerciseComment.from_dict(results_item_data)
        ...
        paginated_exercise_comment_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_exercise_comment_list.additional_properties = d
        return paginated_exercise_comment_list

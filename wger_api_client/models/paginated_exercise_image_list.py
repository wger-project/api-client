...
T = TypeVar("T", bound="PaginatedExerciseImageList")


@_attrs_define
class PaginatedExerciseImageList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ExerciseImage]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ExerciseImage.from_dict(results_item_data)
        ...
        paginated_exercise_image_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_exercise_image_list.additional_properties = d
        return paginated_exercise_image_list

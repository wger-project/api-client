...
T = TypeVar("T", bound="PaginatedExerciseInfoList")


@_attrs_define
class PaginatedExerciseInfoList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ExerciseInfo]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ExerciseInfo.from_dict(results_item_data)
        ...
        paginated_exercise_info_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_exercise_info_list.additional_properties = d
        return paginated_exercise_info_list

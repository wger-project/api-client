...
T = TypeVar("T", bound="PaginatedExerciseList")


@_attrs_define
class PaginatedExerciseList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Exercise.from_dict(results_item_data)
        ...
        paginated_exercise_list.additional_properties = d
        return paginated_exercise_list

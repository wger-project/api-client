...
T = TypeVar("T", bound="PaginatedExerciseTranslationList")


@_attrs_define
class PaginatedExerciseTranslationList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ExerciseTranslation]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ExerciseTranslation.from_dict(results_item_data)
        ...
        paginated_exercise_translation_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_exercise_translation_list.additional_properties = d
        return paginated_exercise_translation_list

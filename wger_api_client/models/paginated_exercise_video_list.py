...
T = TypeVar("T", bound="PaginatedExerciseVideoList")


@_attrs_define
class PaginatedExerciseVideoList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[ExerciseVideo]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = ExerciseVideo.from_dict(results_item_data)
        ...
        paginated_exercise_video_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_exercise_video_list.additional_properties = d
        return paginated_exercise_video_list

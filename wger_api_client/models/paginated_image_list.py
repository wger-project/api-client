...
T = TypeVar("T", bound="PaginatedImageList")
...
class PaginatedImageList:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Image.from_dict(results_item_data)
        ...
        paginated_image_list.additional_properties = d
        return paginated_image_list

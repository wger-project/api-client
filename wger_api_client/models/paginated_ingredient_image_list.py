...
T = TypeVar("T", bound="PaginatedIngredientImageList")


@_attrs_define
class PaginatedIngredientImageList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[IngredientImage]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = IngredientImage.from_dict(results_item_data)
        ...
        paginated_ingredient_image_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_ingredient_image_list.additional_properties = d
        return paginated_ingredient_image_list

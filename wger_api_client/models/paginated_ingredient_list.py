...
T = TypeVar("T", bound="PaginatedIngredientList")


@_attrs_define
class PaginatedIngredientList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Ingredient.from_dict(results_item_data)
        ...
        paginated_ingredient_list.additional_properties = d
        return paginated_ingredient_list

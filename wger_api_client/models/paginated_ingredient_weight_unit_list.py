...
T = TypeVar("T", bound="PaginatedIngredientWeightUnitList")


@_attrs_define
class PaginatedIngredientWeightUnitList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[IngredientWeightUnit]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = IngredientWeightUnit.from_dict(results_item_data)
        ...
        paginated_ingredient_weight_unit_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_ingredient_weight_unit_list.additional_properties = d
        return paginated_ingredient_weight_unit_list

...
T = TypeVar("T", bound="PaginatedLanguageList")


@_attrs_define
class PaginatedLanguageList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Language.from_dict(results_item_data)
        ...
        paginated_language_list.additional_properties = d
        return paginated_language_list

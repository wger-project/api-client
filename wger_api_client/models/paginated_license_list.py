...
T = TypeVar("T", bound="PaginatedLicenseList")


@_attrs_define
class PaginatedLicenseList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = License.from_dict(results_item_data)
        ...
        paginated_license_list.additional_properties = d
        return paginated_license_list

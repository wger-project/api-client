...
T = TypeVar("T", bound="PaginatedLogItemList")


@_attrs_define
class PaginatedLogItemList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = LogItem.from_dict(results_item_data)
        ...
        paginated_log_item_list.additional_properties = d
        return paginated_log_item_list

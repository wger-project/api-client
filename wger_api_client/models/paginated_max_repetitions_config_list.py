...
T = TypeVar("T", bound="PaginatedMaxRepetitionsConfigList")


@_attrs_define
class PaginatedMaxRepetitionsConfigList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MaxRepetitionsConfig]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = MaxRepetitionsConfig.from_dict(results_item_data)
        ...
        paginated_max_repetitions_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_max_repetitions_config_list.additional_properties = d
        return paginated_max_repetitions_config_list

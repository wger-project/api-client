...
T = TypeVar("T", bound="PaginatedMaxRiRConfigList")


@_attrs_define
class PaginatedMaxRiRConfigList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MaxRiRConfig]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = MaxRiRConfig.from_dict(results_item_data)
        ...
        paginated_max_ri_r_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_max_ri_r_config_list.additional_properties = d
        return paginated_max_ri_r_config_list

...
T = TypeVar("T", bound="PaginatedMaxSetNrConfigList")


@_attrs_define
class PaginatedMaxSetNrConfigList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MaxSetNrConfig]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = MaxSetNrConfig.from_dict(results_item_data)
        ...
        paginated_max_set_nr_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_max_set_nr_config_list.additional_properties = d
        return paginated_max_set_nr_config_list

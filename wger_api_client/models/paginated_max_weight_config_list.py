...
T = TypeVar("T", bound="PaginatedMaxWeightConfigList")


@_attrs_define
class PaginatedMaxWeightConfigList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MaxWeightConfig]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = MaxWeightConfig.from_dict(results_item_data)
        ...
        paginated_max_weight_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_max_weight_config_list.additional_properties = d
        return paginated_max_weight_config_list

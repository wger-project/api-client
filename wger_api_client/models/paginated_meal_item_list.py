...
T = TypeVar("T", bound="PaginatedMealItemList")


@_attrs_define
class PaginatedMealItemList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[MealItem]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = MealItem.from_dict(results_item_data)
        ...
        paginated_meal_item_list.additional_properties = d
        return paginated_meal_item_list

...
T = TypeVar("T", bound="PaginatedMealList")


@_attrs_define
class PaginatedMealList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Meal.from_dict(results_item_data)
        ...
        paginated_meal_list.additional_properties = d
        return paginated_meal_list

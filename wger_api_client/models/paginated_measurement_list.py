...
T = TypeVar("T", bound="PaginatedMeasurementList")


@_attrs_define
class PaginatedMeasurementList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Measurement.from_dict(results_item_data)
        ...
        paginated_measurement_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_measurement_list.additional_properties = d
        return paginated_measurement_list

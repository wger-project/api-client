...
T = TypeVar("T", bound="PaginatedMuscleList")


@_attrs_define
class PaginatedMuscleList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Muscle.from_dict(results_item_data)
        ...
        paginated_muscle_list.additional_properties = d
        return paginated_muscle_list

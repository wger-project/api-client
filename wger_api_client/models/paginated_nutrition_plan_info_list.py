...
if TYPE_CHECKING:
    from ..models.nutrition_plan_info import NutritionPlanInfo


T = TypeVar("T", bound="PaginatedNutritionPlanInfoList")


@_attrs_define
class PaginatedNutritionPlanInfoList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[NutritionPlanInfo]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = NutritionPlanInfo.from_dict(results_item_data)
        ...
        paginated_nutrition_plan_info_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_nutrition_plan_info_list.additional_properties = d
        return paginated_nutrition_plan_info_list

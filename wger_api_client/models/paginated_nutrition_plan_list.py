...
T = TypeVar("T", bound="PaginatedNutritionPlanList")


@_attrs_define
class PaginatedNutritionPlanList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[NutritionPlan]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = NutritionPlan.from_dict(results_item_data)
        ...
        paginated_nutrition_plan_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_nutrition_plan_list.additional_properties = d
        return paginated_nutrition_plan_list

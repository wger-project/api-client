...
if TYPE_CHECKING:
    from ..models.repetition_unit import RepetitionUnit


T = TypeVar("T", bound="PaginatedRepetitionUnitList")


@_attrs_define
class PaginatedRepetitionUnitList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[RepetitionUnit]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = RepetitionUnit.from_dict(results_item_data)
        ...
        paginated_repetition_unit_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_repetition_unit_list.additional_properties = d
        return paginated_repetition_unit_list

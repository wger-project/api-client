...
T = TypeVar("T", bound="PaginatedRepetitionsConfigList")


@_attrs_define
class PaginatedRepetitionsConfigList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[RepetitionsConfig]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = RepetitionsConfig.from_dict(results_item_data)
        ...
        paginated_repetitions_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_repetitions_config_list.additional_properties = d
        return paginated_repetitions_config_list

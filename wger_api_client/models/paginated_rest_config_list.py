...
T = TypeVar("T", bound="PaginatedRestConfigList")


@_attrs_define
class PaginatedRestConfigList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[RestConfig]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = RestConfig.from_dict(results_item_data)
        ...
        paginated_rest_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_rest_config_list.additional_properties = d
        return paginated_rest_config_list

...
T = TypeVar("T", bound="PaginatedRiRConfigList")


@_attrs_define
class PaginatedRiRConfigList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[RiRConfig]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = RiRConfig.from_dict(results_item_data)
        ...
        paginated_ri_r_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_ri_r_config_list.additional_properties = d
        return paginated_ri_r_config_list

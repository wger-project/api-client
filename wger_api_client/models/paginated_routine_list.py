...
T = TypeVar("T", bound="PaginatedRoutineList")


@_attrs_define
class PaginatedRoutineList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Routine.from_dict(results_item_data)
        ...
        paginated_routine_list.additional_properties = d
        return paginated_routine_list

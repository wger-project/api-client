...
if TYPE_CHECKING:
    from ..models.routine_weight_unit import RoutineWeightUnit


T = TypeVar("T", bound="PaginatedRoutineWeightUnitList")


@_attrs_define
class PaginatedRoutineWeightUnitList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[RoutineWeightUnit]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = RoutineWeightUnit.from_dict(results_item_data)
        ...
        paginated_routine_weight_unit_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_routine_weight_unit_list.additional_properties = d
        return paginated_routine_weight_unit_list

...
T = TypeVar("T", bound="PaginatedSetNrConfigList")


@_attrs_define
class PaginatedSetNrConfigList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[SetNrConfig]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = SetNrConfig.from_dict(results_item_data)
        ...
        paginated_set_nr_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_set_nr_config_list.additional_properties = d
        return paginated_set_nr_config_list

...
T = TypeVar("T", bound="PaginatedSlotEntryList")


@_attrs_define
class PaginatedSlotEntryList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = SlotEntry.from_dict(results_item_data)
        ...
        paginated_slot_entry_list.additional_properties = d
        return paginated_slot_entry_list

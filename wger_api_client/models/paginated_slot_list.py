...
T = TypeVar("T", bound="PaginatedSlotList")


@_attrs_define
class PaginatedSlotList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Slot.from_dict(results_item_data)
        ...
        paginated_slot_list.additional_properties = d
        return paginated_slot_list

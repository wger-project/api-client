...
T = TypeVar("T", bound="PaginatedTrophyList")


@_attrs_define
class PaginatedTrophyList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = Trophy.from_dict(results_item_data)
        ...
        paginated_trophy_list.additional_properties = d
        return paginated_trophy_list

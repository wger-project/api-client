...
T = TypeVar("T", bound="PaginatedTrophyProgressList")


@_attrs_define
class PaginatedTrophyProgressList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[TrophyProgress]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = TrophyProgress.from_dict(results_item_data)
        ...
        paginated_trophy_progress_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_trophy_progress_list.additional_properties = d
        return paginated_trophy_progress_list

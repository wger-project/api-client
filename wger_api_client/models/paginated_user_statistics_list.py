...
T = TypeVar("T", bound="PaginatedUserStatisticsList")


@_attrs_define
class PaginatedUserStatisticsList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[UserStatistics]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = UserStatistics.from_dict(results_item_data)
        ...
        paginated_user_statistics_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_user_statistics_list.additional_properties = d
        return paginated_user_statistics_list

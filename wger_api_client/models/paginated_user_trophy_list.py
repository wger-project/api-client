...
if TYPE_CHECKING:
    from ..models.user_trophy import UserTrophy


T = TypeVar("T", bound="PaginatedUserTrophyList")


@_attrs_define
class PaginatedUserTrophyList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[UserTrophy]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = UserTrophy.from_dict(results_item_data)
        ...
        paginated_user_trophy_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_user_trophy_list.additional_properties = d
        return paginated_user_trophy_list

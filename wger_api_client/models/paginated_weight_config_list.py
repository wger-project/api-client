...
T = TypeVar("T", bound="PaginatedWeightConfigList")


@_attrs_define
class PaginatedWeightConfigList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[WeightConfig]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = WeightConfig.from_dict(results_item_data)
        ...
        paginated_weight_config_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_weight_config_list.additional_properties = d
        return paginated_weight_config_list

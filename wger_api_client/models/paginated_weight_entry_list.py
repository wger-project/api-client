...
T = TypeVar("T", bound="PaginatedWeightEntryList")


@_attrs_define
class PaginatedWeightEntryList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = WeightEntry.from_dict(results_item_data)
        ...
        paginated_weight_entry_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_weight_entry_list.additional_properties = d
        return paginated_weight_entry_list

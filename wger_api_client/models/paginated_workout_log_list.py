...
T = TypeVar("T", bound="PaginatedWorkoutLogList")


@_attrs_define
class PaginatedWorkoutLogList:
    """
    Attributes:
        count (int):  Example: 123.
        results (list[WorkoutLog]):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = WorkoutLog.from_dict(results_item_data)
        ...
        paginated_workout_log_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_workout_log_list.additional_properties = d
        return paginated_workout_log_list

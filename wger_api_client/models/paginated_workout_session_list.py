...
T = TypeVar("T", bound="PaginatedWorkoutSessionList")


@_attrs_define
class PaginatedWorkoutSessionList:
    """
    Attributes:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        for results_item_data in _results:
            results_item = WorkoutSession.from_dict(results_item_data)
        ...
        paginated_workout_session_list = cls(
            count=count,
            results=results,
            next_=next_,
            previous=previous,
        ...
        paginated_workout_session_list.additional_properties = d
        return paginated_workout_session_list

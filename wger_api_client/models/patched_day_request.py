...
T = TypeVar("T", bound="PatchedDayRequest")


@_attrs_define
class PatchedDayRequest:
    """Day serializer
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_day_request.additional_properties = d
        return patched_day_request

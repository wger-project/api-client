...
@_attrs_define
class PatchedExerciseImageRequest:
    """ExerciseImage serializer

    Attributes:
        exercise (int | Unset):
        image (File | Unset): Only JPEG, PNG and WebP formats are supported
        is_main (bool | Unset):
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_exercise_image_request = cls(
            exercise=exercise,
            image=image,
            is_main=is_main,
            style=style,
        ...
        patched_exercise_image_request.additional_properties = d
        return patched_exercise_image_request

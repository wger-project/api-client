...
T = TypeVar("T", bound="PatchedMaxRepetitionsConfigRequest")


@_attrs_define
class PatchedMaxRepetitionsConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_max_repetitions_config_request = cls(
        ...
        patched_max_repetitions_config_request.additional_properties = d
        return patched_max_repetitions_config_request

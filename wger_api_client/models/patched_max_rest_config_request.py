...
T = TypeVar("T", bound="PatchedMaxRestConfigRequest")


@_attrs_define
class PatchedMaxRestConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_max_rest_config_request = cls(
        ...
        patched_max_rest_config_request.additional_properties = d
        return patched_max_rest_config_request

...
T = TypeVar("T", bound="PatchedMaxRiRConfigRequest")


@_attrs_define
class PatchedMaxRiRConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_max_ri_r_config_request = cls(
        ...
        patched_max_ri_r_config_request.additional_properties = d
        return patched_max_ri_r_config_request

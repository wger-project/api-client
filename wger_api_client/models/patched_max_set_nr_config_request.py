...
T = TypeVar("T", bound="PatchedMaxSetNrConfigRequest")


@_attrs_define
class PatchedMaxSetNrConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_max_set_nr_config_request = cls(
        ...
        patched_max_set_nr_config_request.additional_properties = d
        return patched_max_set_nr_config_request

...
T = TypeVar("T", bound="PatchedMaxWeightConfigRequest")


@_attrs_define
class PatchedMaxWeightConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_max_weight_config_request = cls(
        ...
        patched_max_weight_config_request.additional_properties = d
        return patched_max_weight_config_request

...
@_attrs_define
class PatchedNutritionPlanRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_nutrition_plan_request = cls(
            id=id,
            start=start,
            end=end,
        ...
        patched_nutrition_plan_request.additional_properties = d
        return patched_nutrition_plan_request

...
T = TypeVar("T", bound="PatchedRestConfigRequest")


@_attrs_define
class PatchedRestConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_rest_config_request = cls(
        ...
        patched_rest_config_request.additional_properties = d
        return patched_rest_config_request

...
T = TypeVar("T", bound="PatchedRiRConfigRequest")


@_attrs_define
class PatchedRiRConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_ri_r_config_request = cls(
        ...
        patched_ri_r_config_request.additional_properties = d
        return patched_ri_r_config_request

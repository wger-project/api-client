...
T = TypeVar("T", bound="PatchedSetNrConfigRequest")


@_attrs_define
class PatchedSetNrConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        patched_set_nr_config_request = cls(
        ...
        patched_set_nr_config_request.additional_properties = d
        return patched_set_nr_config_request

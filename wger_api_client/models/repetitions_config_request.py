...
T = TypeVar("T", bound="RepetitionsConfigRequest")


@_attrs_define
class RepetitionsConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        repetitions_config_request = cls(
            slot_entry=slot_entry,
            iteration=iteration,
            value=value,
            operation=operation,
        ...
        repetitions_config_request.additional_properties = d
        return repetitions_config_request

...
T = TypeVar("T", bound="RestConfigRequest")


@_attrs_define
class RestConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        rest_config_request.additional_properties = d
        return rest_config_request

...
T = TypeVar("T", bound="SetNrConfigRequest")


@_attrs_define
class SetNrConfigRequest:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        set_nr_config_request.additional_properties = d
        return set_nr_config_request

...
class UserprofileRequest:
    ...
    def to_multipart(self) -> types.RequestFiles:
        ...
        if not isinstance(self.repetitions_rounding, Unset):
            if isinstance(self.repetitions_rounding, str):
                files.append(
                    (
                        "repetitions_rounding",
                        (None, str(self.repetitions_rounding).encode(), "text/plain"),
                    )
                )
            else:
                files.append(
        ...
        if not isinstance(self.workout_reminder_active, Unset):
            files.append(
                (
                    "workout_reminder_active",
                    (None, str(self.workout_reminder_active).encode(), "text/plain"),
                )
            )

        if not isinstance(self.workout_reminder, Unset):
            files.append(
                (
                    "workout_reminder",
                    (None, str(self.workout_reminder).encode(), "text/plain"),
                )
            )

        if not isinstance(self.workout_duration, Unset):
            files.append(
                (
                    "workout_duration",
                    (None, str(self.workout_duration).encode(), "text/plain"),
                )
            )

        if not isinstance(self.notification_language, Unset):
            files.append(
                (
                    "notification_language",
                    (None, str(self.notification_language).encode(), "text/plain"),
                )
            )
        ...
        if not isinstance(self.birthdate, Unset):
            if isinstance(self.birthdate, datetime.date):
                files.append(
                    (
                        "birthdate",
                        (None, self.birthdate.isoformat().encode(), "text/plain"),
                    )
                )
            else:
                files.append(
                    ("birthdate", (None, str(self.birthdate).encode(), "text/plain"))
                )

        if not isinstance(self.height, Unset):
            if isinstance(self.height, int):
                files.append(
                    ("height", (None, str(self.height).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("height", (None, str(self.height).encode(), "text/plain"))
        ...
        if not isinstance(self.gender, Unset):
            if isinstance(self.gender, GenderEnum):
                ...
                files.append(
                    ("gender", (None, str(self.gender).encode(), "text/plain"))
                )

        if not isinstance(self.sleep_hours, Unset):
            if isinstance(self.sleep_hours, int):
                files.append(
                    (
                        "sleep_hours",
                        (None, str(self.sleep_hours).encode(), "text/plain"),
                    )
                )
            else:
                files.append(
        ...
        if not isinstance(self.work_hours, Unset):
            if isinstance(self.work_hours, int):
                files.append(
                    ("work_hours", (None, str(self.work_hours).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("work_hours", (None, str(self.work_hours).encode(), "text/plain"))
        ...
        if not isinstance(self.work_intensity, Unset):
            if isinstance(self.work_intensity, IntensityEnum):
                files.append(
                    (
                        "work_intensity",
                        (None, str(self.work_intensity.value).encode(), "text/plain"),
                    )
                )
            else:
                files.append(
                    (
                        "work_intensity",
                        (None, str(self.work_intensity).encode(), "text/plain"),
                    )
                )

        if not isinstance(self.sport_hours, Unset):
            if isinstance(self.sport_hours, int):
                files.append(
                    (
                        "sport_hours",
                        (None, str(self.sport_hours).encode(), "text/plain"),
                    )
                )
            else:
                files.append(
        ...
        if not isinstance(self.sport_intensity, Unset):
            if isinstance(self.sport_intensity, IntensityEnum):
                files.append(
                    (
                        "sport_intensity",
                        (None, str(self.sport_intensity.value).encode(), "text/plain"),
                    )
                )
            else:
                files.append(
                    (
                        "sport_intensity",
                        (None, str(self.sport_intensity).encode(), "text/plain"),
                    )
                )

        if not isinstance(self.freetime_hours, Unset):
            if isinstance(self.freetime_hours, int):
                files.append(
                    (
                        "freetime_hours",
                        (None, str(self.freetime_hours).encode(), "text/plain"),
                    )
                )
            else:
                files.append(
        ...
        if not isinstance(self.freetime_intensity, Unset):
            if isinstance(self.freetime_intensity, IntensityEnum):
                files.append(
                    (
                        "freetime_intensity",
                        (
                            None,
                            str(self.freetime_intensity.value).encode(),
                            "text/plain",
                        ),
                    )
                )
                ...
                files.append(
                    (
                        "freetime_intensity",
                        (None, str(self.freetime_intensity).encode(), "text/plain"),
                    )
                )

        if not isinstance(self.calories, Unset):
            if isinstance(self.calories, int):
                files.append(
                    ("calories", (None, str(self.calories).encode(), "text/plain"))
                )
            else:
                files.append(
                    ("calories", (None, str(self.calories).encode(), "text/plain"))
        ...
        if not isinstance(self.weight_unit, Unset):
            files.append(
                (
                    "weight_unit",
                    (None, str(self.weight_unit.value).encode(), "text/plain"),
                )
            )

        if not isinstance(self.num_days_weight_reminder, Unset):
            files.append(
                (
                    "num_days_weight_reminder",
                    (None, str(self.num_days_weight_reminder).encode(), "text/plain"),
                )
            )
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        userprofile_request.additional_properties = d
        return userprofile_request

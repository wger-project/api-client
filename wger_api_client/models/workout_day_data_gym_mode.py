...
T = TypeVar("T", bound="WorkoutDayDataGymMode")


@_attrs_define
class WorkoutDayDataGymMode:
    ...
    def from_dict(cls, src_dict: Mapping[str, Any]) -> Self:
        ...
        workout_day_data_gym_mode.additional_properties = d
        return workout_day_data_gym_mode
